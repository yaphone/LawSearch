...
class LawSearch:
  def __init__(self):
    ...
    self.lawJson = {}
  def main(self): 
    fs = io.open('C:/Users/zhouy/Desktop/Github/wechat-miniapp/LawSearch/py/zaglcff/zaglcff.txt', mode='r', encoding='utf-8')
    lawStr = fs.read()
    self.process(lawStr)
  ...
  def process(self, lawStr):
    ...
    fs = io.open('C:/Users/zhouy/Desktop/Github/wechat-miniapp/LawSearch/py/zaglcff/zaglcff_process.txt', mode='w', encoding='utf-8')
    fs.write(ret)  
